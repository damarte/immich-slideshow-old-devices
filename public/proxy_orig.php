...
try {
    ...
    // // Use the smaller scaling factor to ensure the WHOLE image fits inside the screen
    ...
    // // Create the new image at screen size
    // $resized = imagecreatetruecolor($screen_width, $screen_height);

    // // Fill the background with your chosen color (black)
    // $bgColor = imagecolorallocate($resized, 0, 0, 0);
    // imagefill($resized, 0, 0, $bgColor);
    
    // // Resize the image without cropping
    // imagecopyresampled(
    //     $resized, $source,
    //     $dest_x, $dest_y,    // Center it in the destination
    //     0, 0,                // Start from 0,0 of source
    //     $scaled_width, $scaled_height, 
    //     $source_width, $source_height
    // );

    // //Don't Fullscreen images^
